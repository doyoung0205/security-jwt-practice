...
//    })
    ...
    public SingleResult<User> findUser() {
        ...
        return responseService.getSingleResult(userJpaRepo.findById(principal.getMsrl()).orElseThrow(CUserNotFoundException::new));
    }
...
//    })
    ...
    public SingleResult<User> modify(
        ...
        Authentication authentication = SecurityContextHolder.getContext().getAuthentication();
        User principal = (User) authentication.getPrincipal();
        User user = userJpaRepo.findById(principal.getMsrl()).orElseThrow(CUserNotFoundException::new);
